...
import com.once.crosscloud.security.models.RecordEntity;
import com.once.crosscloud.security.services.LogInfoService;
...
public class LogAspect {
	 ...
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controllers.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controllers.*.update(..)) "
			+ "|| execution(* com.once.crosscloud.*.controllers.*.resetPassword(..)) "
			+ "|| execution(* com.once.crosscloud.*.controllers.*.info(..)) "
			+ "|| execution(* com.once.crosscloud.*.controllers.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controllers.*.delete*(..))")
	 ...
	 * 删除业务逻辑方法切入点 定义在controller包里以delete为前缀的方法的执行
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controllers.*.permission(..))")
	...
	public void insertServiceCallCalls(JoinPoint joinPoint, Object rtv)
		...
		// 创建日志对象
		RecordEntity log = new RecordEntity();
