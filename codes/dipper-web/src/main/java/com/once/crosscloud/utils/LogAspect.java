...
public class LogAspect {
	 ...
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controller.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controller.*.update(..)) "
			+ "|| execution(* com.once.crosscloud.*.controller.*.resetPassword(..)) "
			+ "|| execution(* com.once.crosscloud.*.controller.*.info(..)) "
			+ "|| execution(* com.once.crosscloud.*.controller.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controller.*.delete*(..))")
	 ...
	 * 删除业务逻辑方法切入点 定义在controller包里以delete为前缀的方法的执行
	 */
	@Pointcut("execution(* com.once.crosscloud.*.controller.*.permission(..))")
