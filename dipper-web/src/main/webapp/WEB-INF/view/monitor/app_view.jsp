...
<script src="${basePath }js/console/monitor_appview.js"></script>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active"><b>应用维度</b></li>
					</ul>
				</div>
				<div class="page-header">
					<h1>
						欢迎来到监控管理（应用维度） <small> <br>监控管理为平台提供运维功能，通过不同维度的视角查看服务器和发布的应用所属容器的各项负载信息。
							<br>点击【应用名称】列，进入对应应用的监控视图页面。
						</small>
					</h1>
				</div>
