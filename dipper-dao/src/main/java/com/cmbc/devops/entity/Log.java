...
public class Log {
	...
	public Log(Integer logId, String logObject, String logAction, String logResult, Integer userId, String userIp,
			Date logCreatetime, Date beginTime, Date endTime, String logDetail) {
		super();
		this.logId = logId;
		this.logObject = logObject;
		this.logAction = logAction;
